...
const PERMANENT_EQUIPMENTS = [
  { equipment: "ZY-190 PLANK MILL", enpiUnit: "KwH/MT" },
  { equipment: "DDF 95.0D", enpiUnit: "KwH/MT" },
  { equipment: "ZY-140", enpiUnit: "KwH/MT" },
  { equipment: "GMT-1", enpiUnit: "KwH/MT" },
  { equipment: "GMT-2", enpiUnit: "KwH/MT" },
  { equipment: "GMT-4", enpiUnit: "KwH/MT" },
  { equipment: "ZY-76 (LTZ)", enpiUnit: "KwH/MT" },
  { equipment: "GMT-3", enpiUnit: "KwH/MT" },
  { equipment: "ZY-76", enpiUnit: "KwH/MT" },
  { equipment: "ZY-63", enpiUnit: "KwH/MT" },
  { equipment: "ZY-38", enpiUnit: "KwH/MT" },
  { equipment: "ZY-25", enpiUnit: "KwH/MT" },
  { equipment: "CRS-1", enpiUnit: "KwH/MT" },
  { equipment: "CRS-2", enpiUnit: "KwH/MT" },
  { equipment: "CRS-3", enpiUnit: "KwH/MT" },
  { equipment: "PUMP HOUSE", enpiUnit: "KwH/MT" },
  { equipment: "COMPRESSOR", enpiUnit: "CFM/KWH" },
  { equipment: "OTHER AUX LOAD & works", enpiUnit: "KwH/MT" }
];
...
export default function NarrowTubePage() {
  ...
  const handleDownloadSample = () => {
    ...
    XLSX.writeFile(wb, `Narrow_Tube_${selectedMonth}.xlsx`);
  };
    ...
    <div className="min-h-screen bg-white text-slate-800 p-6 md:p-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-slate-200">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800">Narrow Tube (NTD) Facility Dashboard</h1>
      ...
      {showUploader && (
        <div className="mt-4 p-6 border-2 border-dashed border-blue-400 rounded-2xl bg-blue-50/50 flex flex-col items-center justify-center gap-3">
          ...
          <p className="text-sm font-medium text-slate-600">Select Narrow Tube `.xlsx` file to populate the schema</p>
          <input
            type="file"
            accept=".xlsx, .xls"
      ...
      <div className="mt-6 overflow-x-auto rounded-xl border border-slate-300 shadow-sm bg-white">
        <table className="w-full text-xs text-center border-collapse">
          ...
          <tbody className="divide-y divide-slate-200 font-medium text-slate-700">
            {rows.map((r, idx) => {
              const isHighlight = ['COMPRESSOR', 'GMT-1', 'GMT-2', 'PUMP HOUSE'].includes(r.equipment);
            ...
            <tr className="bg-[#bbf7d0] text-black font-extrabold text-xs">
              <td className="p-3 text-left border border-slate-400">Total NTD Facility</td>
