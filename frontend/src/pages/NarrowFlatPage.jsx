...
const PERMANENT_EQUIPMENTS = [
  { equipment: "PICKLING", enpiUnit: "KwH/MT", labelBg: "#0284c7", textCol: "#ffffff" },
  { equipment: "HRS1", enpiUnit: "KwH/MT", labelBg: "#059669", textCol: "#ffffff" },
  { equipment: "HRS2", enpiUnit: "KwH/MT", labelBg: "#d97706", textCol: "#ffffff" },
  { equipment: "CRM", enpiUnit: "KwH/MT", labelBg: "#ea580c", textCol: "#ffffff" },
  { equipment: "CGL", enpiUnit: "KwH/MT", labelBg: "#e11d48", textCol: "#ffffff" },
  { equipment: "CCL", enpiUnit: "KwH/MT", labelBg: "#0891b2", textCol: "#ffffff" },
  { equipment: "SPM", enpiUnit: "KwH/MT", labelBg: "#9333ea", textCol: "#ffffff" },
  { equipment: "BELL ANNEALING", enpiUnit: "KwH/MT", labelBg: "#0d9488", textCol: "#ffffff" },
  { equipment: "PACKAGING M/C", enpiUnit: "KwH/MT", labelBg: "#c2410c", textCol: "#ffffff" },
  { equipment: "CTL", enpiUnit: "KwH/MT", labelBg: "#7c3aed", textCol: "#ffffff" },
  { equipment: "CRS1", enpiUnit: "KwH/MT", labelBg: "#db2777", textCol: "#ffffff" },
  { equipment: "CRS2", enpiUnit: "KwH/MT", labelBg: "#65a30d", textCol: "#ffffff" },
  { equipment: "NARROW TUBE AUX", enpiUnit: "KwH/MT", labelBg: "#38bdf8", textCol: "#000000" },
  { equipment: "BOILER", enpiUnit: "KG/TPH", labelBg: "#4ade80", textCol: "#000000" },
  { equipment: "CHILLER", enpiUnit: "KwH/Day", labelBg: "#facc15", textCol: "#000000" },
  { equipment: "COMPRESSOR", enpiUnit: "CFM/Kwh", labelBg: "#fb923c", textCol: "#000000" },
  { equipment: "COOLING TOWER", enpiUnit: "KwH/Day", labelBg: "#22d3ee", textCol: "#000000" },
  { equipment: "LPG Yard", enpiUnit: "KwH/Day", labelBg: "#c084fc", textCol: "#000000" },
  { equipment: "HYDROGEN", enpiUnit: "KwH/Day", labelBg: "#f472b6", textCol: "#000000" },
  { equipment: "STREET LIGHT", enpiUnit: "Kwh", labelBg: "#a3e635", textCol: "#000000" },
  { equipment: "WORKSHOP", enpiUnit: "KwH/Day", labelBg: "#2dd4bf", textCol: "#000000" },
  { equipment: "ADMIN OFFICE", enpiUnit: "KwH/Day", labelBg: "#fb7185", textCol: "#000000" },
  { equipment: "DG Set 2000kVA", enpiUnit: "KwH/LTR", labelBg: "#fdba74", textCol: "#000000" },
  { equipment: "Material Handling", enpiUnit: "Ltr/Day", labelBg: "#94a3b8", textCol: "#000000" },
  { equipment: "Other works", enpiUnit: "KwH", labelBg: "#e879f9", textCol: "#000000" }
];
...
export default function NarrowFlatPage() {
  ...
  // Pie Chart Data (CRM, CGL, CCL, COMPRESSOR, BOILER + OTHERS)
  ...
  return (
    <div className="plant-theme plant-theme-narrow-flat" style={{ display: 'flex', flexDirection: 'column', gap: '24px', padding: '24px', backgroundColor: '#020617', minHeight: '100vh', color: '#f8fafc', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
                ...
                return (
                  <tr key={idx} data-equipment={r.equipment} style={{ borderBottom: '1px solid #000', fontWeight: 'bold' }}>
                    ...
                    <td style={{ backgroundColor: config.labelBg || '#0284c7', color: config.textCol || '#ffffff', padding: '10px 8px', borderRight: '2px solid #000', textAlign: 'left', fontWeight: '900', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                      <Link style={{color: 'inherit', textDecoration: 'underline', textUnderlineOffset: '4px'}} to={`/equipment/narrow-flat?${new URLSearchParams({equipment: r.equipment, month: selectedMonth})}`}>{r.equipment} ↗</Link>
                    </td>
      ...
      <div style={{ marginTop: '8px' }}>
        <h2 style={{ fontSize: '22px', fontWeight: '900', marginBottom: '20px', letterSpacing: '1px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span style={{ color: '#38bdf8' }}>FLAT</span>
