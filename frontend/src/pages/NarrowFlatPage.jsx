...
// Permanent 25 Process / Equipments list according to Narrow Flat layout
const PERMANENT_EQUIPMENTS = [
  { equipment: "PICKLING", enpiUnit: "KwH/MT" },
  { equipment: "HRS1", enpiUnit: "KwH/MT" },
  { equipment: "HRS2", enpiUnit: "KwH/MT" },
  { equipment: "CRM", enpiUnit: "KwH/MT" },
  { equipment: "CGL", enpiUnit: "KwH/MT" },
  { equipment: "CCL", enpiUnit: "KwH/MT" },
  { equipment: "SPM", enpiUnit: "KwH/MT" },
  { equipment: "BELL ANNEALING", enpiUnit: "KwH/MT" },
  { equipment: "PACKAGING M/C", enpiUnit: "KwH/MT" },
  { equipment: "CTL", enpiUnit: "KwH/MT" },
  { equipment: "CRS1", enpiUnit: "KwH/MT" },
  { equipment: "CRS2", enpiUnit: "KwH/MT" },
  { equipment: "NARROW TUBE AUX", enpiUnit: "KwH/MT" },
  { equipment: "BOILER", enpiUnit: "KG/TPH" },
  { equipment: "CHILLER", enpiUnit: "KwH/Day" },
  { equipment: "COMPRESSOR", enpiUnit: "CFM/Kwh" },
  { equipment: "COOLING TOWER", enpiUnit: "KwH/Day" },
  { equipment: "LPG Yard", enpiUnit: "KwH/Day" },
  { equipment: "HYDROGEN", enpiUnit: "KwH/Day" },
  { equipment: "STREET LIGHT", enpiUnit: "Kwh" },
  { equipment: "WORKSHOP", enpiUnit: "KwH/Day" },
  { equipment: "ADMIN OFFICE", enpiUnit: "KwH/Day" },
  { equipment: "DG Set 2000kVA", enpiUnit: "KwH/LTR" },
  { equipment: "Material Handling", enpiUnit: "Ltr/Day" },
  { equipment: "Other works", enpiUnit: "KwH" }
];

const COLORS = ['#6366f1', '#06b6d4', '#10b981', '#f59e0b', '#ec4899', '#8b5cf6'];

export default function NarrowFlatPage() {
  ...
  // Pie Chart Data Formatter (CRM, CGL, CCL, COMPRESSOR, BOILER + OTHERS)
  const getCategorizedData = (key) => {
    const mainKeys = ['CRM', 'CGL', 'CCL', 'COMPRESSOR', 'BOILER'];
    let mainItems = [];
    let othersVal = 0;
  ...
  const handleDownloadSample = () => {
    ...
    XLSX.writeFile(wb, `Narrow_Flat_${selectedMonth}.xlsx`);
  };
    ...
    <div className="min-h-screen bg-white text-slate-800 p-6 md:p-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-slate-200">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800">Narrow Flat Facility Dashboard</h1>
      ...
      <div className="mt-6 flex flex-wrap items-center gap-4">
        ...
        <button
          onClick={() => navigate('/narrow-flat/yoy')}
      ...
      {showUploader && (
        <div className="mt-4 p-6 border-2 border-dashed border-blue-400 rounded-2xl bg-blue-50/50 flex flex-col items-center justify-center gap-3">
          ...
          <p className="text-sm font-medium text-slate-600">Select Narrow Flat `.xlsx` file to parse and populate the schema</p>
          <input
            type="file"
            accept=".xlsx, .xls"
      ...
      <div className="mt-6 overflow-x-auto rounded-xl border border-slate-300 shadow-sm bg-white">
        <table className="w-full text-xs text-center border-collapse">
          ...
          <tbody className="divide-y divide-slate-200 font-medium text-slate-700">
            {rows.map((r, idx) => {
              const isHighlight = ['CRM', 'CGL', 'CCL', 'COMPRESSOR', 'BOILER'].includes(r.equipment);
            ...
            <tr className="bg-[#bbf7d0] text-black font-extrabold text-xs">
              <td className="p-3 text-left border border-slate-400">Total Narrow Facility</td>
